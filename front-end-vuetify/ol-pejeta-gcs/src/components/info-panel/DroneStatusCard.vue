  ...
  <v-card class="mb-2 rounded-lg vehicle-status-card" elevation="8">
    ...
    <v-card-title class="px-3 py-2 d-flex align-center justify-space-between">
      <div class="d-flex align-center">
        <v-icon class="me-2" color="purple-lighten-1" icon="mdi-quadcopter" size="small"></v-icon>
        <span class="text-subtitle-1 font-weight-bold">Drone Status</span>
      </div>
    ...
    <v-container fluid>
      <v-row dense>
        <v-col cols="12">
          <v-sheet :color="operationalStatusColor" class="py-2 text-center" rounded>
